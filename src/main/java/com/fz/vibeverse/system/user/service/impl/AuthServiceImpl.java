...
import com.fz.vibeverse.common.web.ServletUtils;
...
import com.fz.vibeverse.system.user.domain.entity.SysPermission;
import com.fz.vibeverse.system.user.domain.entity.SysRole;
import com.fz.vibeverse.system.user.domain.entity.SysRolePermission;
...
import com.fz.vibeverse.system.user.domain.vo.AuthUserInfoVo;
import com.fz.vibeverse.system.user.mapper.SysPermissionMapper;
import com.fz.vibeverse.system.user.mapper.SysRoleMapper;
import com.fz.vibeverse.system.user.mapper.SysRolePermissionMapper;
...
import com.fz.vibeverse.system.user.service.SecurityAuditService;
...
public class AuthServiceImpl implements AuthService {
    ...
    @Value("${vibe-verse.auth.refresh-token.secret:vibe-verse-local-refresh-secret}")
    private String refreshTokenSecret;

    @Value("${vibe-verse.auth.refresh-token.ttl-seconds:604800}")
